 ...
 * @param {string} props.repoUrl - GitHubリポジトリのURL
 * @param {string} props.title - タイトル属性
 * @returns {JSX.Element} - GitHubアイコンコンポーネント
 */
const GithubIcon = ({
  repoUrl = 'https://github.com/nixiy/ExifCropFrame',
  title = 'GitHubリポジトリ',
}) => (
  <a href={repoUrl} target="_blank" rel="noopener noreferrer" className="github-link" title={title}>
